        ...
        <div class="row">
            ...
            <div class="col-9">
                <div class="card" style="margin-top: 20px;">
                    ...
                    <div class="card-body">
                        <h4>Ta的bot</h4>
                        <table class="table table-striped table-hover" v-if="bots.length!==0">
                            <thead>
                                <tr>
                                    <th>名称</th>
                                    <th>创建时间</th>
                        ...
                        <div v-else>
                            <span class="badge text-bg-primary">纯手玩</span>
                            <span class="badge text-bg-secondary">纯手玩</span>
                            <span class="badge text-bg-success">纯手玩</span>
                            <span class="badge text-bg-danger">纯手玩</span>
                            <span class="badge text-bg-warning">纯手玩</span>
                            <span class="badge text-bg-info">纯手玩</span>
